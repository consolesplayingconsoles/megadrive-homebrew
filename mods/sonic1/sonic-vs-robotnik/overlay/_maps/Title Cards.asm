...
; sonic-vs-robotnik: empty mapping used to hide the title-card ACT number.
Map_CardBlank:	mappingsTable
	mappingsTableEntry.w	M_CardBlank
M_CardBlank:	spriteHeader
M_CardBlank_End
