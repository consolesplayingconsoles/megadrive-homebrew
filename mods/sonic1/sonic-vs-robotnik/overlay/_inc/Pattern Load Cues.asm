...
plcid_SwissFire:	plcptr	PLC_SwissFire		; sonic-vs-robotnik: MZ fireball art, loaded on demand by the Swiss Army Knife super-boss
...
PLC_MZ:		plcheader
		...
		plcm	Nem_MzFire,	ArtTile_MZ_Fireball		; fireballs (lava balls, at $345)
		plcm	Nem_MzFire,	$530				; sonic-vs-robotnik: same art at $530 for Eggman's
		plcm	Nem_Swing,	ArtTile_GHZ_MZ_Swing		; BossFire (moved off $345 -- see 73,74). swinging platform
...
; ---------------------------------------------------------------------------
; sonic-vs-robotnik: just the MZ fireball, force-loaded on the Spring Yard arena so
; the Swiss Army Knife super-boss's flamethrower renders ($345 is below the boss art).
; ---------------------------------------------------------------------------
PLC_SwissFire:	plcheader
		plcm	Nem_MzFire,	$530				; sonic-vs-robotnik: relocated off $345 (SYZ bg
PLC_SwissFire_end:						; tiles) into the free $530 gap so Spring Yard's background stays intact
